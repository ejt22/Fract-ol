...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/09/08 15:21:08 by ejoo-tho          #+#    #+#              #
#    Updated: 2022/09/29 11:10:03 by ejoo-tho         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):	${OBJS} ${MLX}
				...
				@echo $(Green)√$(Color_Off)$(Cyan)Fractol Has Been Compiled!$(Color_Off);
